...
export default function Card({servicio, enlace}) {
    ...
    const pruebaBackend = () => {
        dispatch(consultarApiMercadoPago())
    }
  return (
    <div className={styles.parent}>
    <div className={styles.card}>
        <div className={styles.logo}>
            <span className={styles.circle} circle1></span>
            <span className={styles.circle} circle2></span>
            <span className={styles.circle} circle3></span>
            <span className={styles.circle} circle4></span>
            <span className={styles.circle} circle5>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.667 31.69" className={styles.svg}>
        ...
        <div className={styles.content}>
            ...
            <span className={styles.text}>Create, share, and use beautiful custom elements made with CSS</span>
        </div>
        <div className={styles.bottom}>
            
            <div className={styles.socialButtonsContainer}>
                <button onClick={ () =>botonIg()} className={styles.socialButton} social-button1>
                  ...
                  <button onClick={ () => pruebaBackend()} className={styles.socialButton} social-button2>
                  ...
                  <button className={styles.socialButton} social-button3>
